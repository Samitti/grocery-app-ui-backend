...
class BodyCategoryListScreen extends StatefulWidget {
  const BodyCategoryListScreen({super.key});

  @override
  State<BodyCategoryListScreen> createState() => _BodyCategoryListScreenState();
}

class _BodyCategoryListScreenState extends State<BodyCategoryListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return productByCategory.isEmpty
        ? const EmptyWidget()
        : SingleChildScrollView(
            child: Column(
              children: [
                      ...
                      decoration: InputDecoration(
                        ...
                        suffix: IconButton(
                          ...
                          icon: Icon(
                            Icons.close,
                            color:
                                _searchFouceNode.hasFocus ? Colors.red : color,
                          ),
                        ),
                      ),
                    ),
                ...
                productProvider.bySearch.isEmpty
                    ? const EmptyWidget()
                    : GridView.count(
